...
Description: Makes media thumbs match the WordPress thumbnail size or a custom size named 'mte_thumbnail'
...
function mte_admin_css(){
	...
	echo '<style>';
	echo '.fixed .column-mte_thumb{ width: '.$w.'px; text-align: center; }';
	echo '</style>';
